document.addEventListener('DOMContentLoaded', function() {
  ...
  function generateQuestion(shapeId) {
    ...
    switch (shapeId) {
      case 'rhombus':
        question.a = getRandomInt(5, 12);
        question.d1 = getRandomInt(5, 15);
        question.d2 = getRandomInt(5, 15);
      ...
      case 'kite':
        question.a = getRandomInt(5, 10);
        question.b = getRandomInt(5, 10);
        question.d1 = getRandomInt(8, 16);
        question.d2 = getRandomInt(5, 12);
