...
let state = {
  scoreHistory: [],
  highScore: localStorage.getItem('cuberootHighScore') || 0,
  score: 0,
  streak: 0,
...
function trackScore(points, timeTaken, isStreakBonus = false) {
  ...
  if (state.score > state.highScore) {
    ...
    localStorage.setItem('cuberootHighScore', state.highScore);
  }
